  ...
  "inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none transition-colors overflow-hidden",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-transparent bg-warning/15 text-warning-foreground dark:text-warning [a&]:hover:bg-warning/25 dark:bg-warning/20",
        info: "border-transparent bg-info/15 text-info [a&]:hover:bg-info/25 dark:bg-info/20",
      },
    },
    defaultVariants: {
      variant: "default",
